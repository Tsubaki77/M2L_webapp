...
const DetailSalles = () => {
  ...
  if (loading) return <div className="d-flex flex-column align-items-center justify-content-center h-100"><div className="spinner-border text-danger mb-3"></div><p className="text-muted">Chargement...</p></div>;
  if (!salle) return <div className="d-flex flex-column align-items-center justify-content-center h-100"><h3 className="text-danger fw-bold">Salle introuvable</h3><button onClick={() => navigate('/mes_salles')} className="btn btn-outline-dark mt-3">Retour</button></div>;
  ...
  return (
    <div className="d-flex flex-column h-100 overflow-hidden">
         ...
         <div className="container-fluid px-4 mt-3 pb-5">
            ...
            <div className="mb-4">
                ...
                <div className="position-relative rounded-4 overflow-hidden shadow" style={{ height: '450px', backgroundColor: '#212529' }}>
                    <img src={salle.images[activeIndex]} alt="Vue salle" className="w-100 h-100 object-fit-cover fade-in-img" key={activeIndex} />
                    ...
                    {salle.images.map((img, index) => (
                        <div key={index} className="col-md-6"> 
                            <div className="card border-0 shadow-sm h-100 overflow-hidden rounded-4" style={{ height: '350px' }}>
                                <img src={img} alt={`Vue ${index + 1}`} className="w-100 h-100 object-fit-cover hover-zoom" />
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="col-lg-8">
                    <div className="card shadow border-0 mb-4" style={{ borderRadius: '16px', borderTop: '4px solid #CC4040' }}>
                        <div className="card-body p-4">
                            ...
                            {/* ÉQUIPEMENTS AVEC SCROLL HORIZONTAL */}
                            <div>
                    ...
                    <div className="sticky-top d-flex flex-column gap-4" style={{ top: '20px', zIndex: 10 }}>
                        <div className="card shadow-sm border-0 w-100" style={{ borderRadius: '16px', backgroundColor: '#FAFAFA' }}>
                            <div className="card-body p-4 text-center">
                                ...
                                <button onClick={() => navigate(`/salles/${salle.id}/calendrier`)} className="btn w-100 py-3 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2" style={{ backgroundColor: '#770505', color: '#FFF', borderRadius: '12px' }}>
                        ...
                        <div className="card shadow-sm border-0 w-100" style={{ borderRadius: '16px', backgroundColor: '#FAFAFA' }}>
                            <div className="card-body p-4 d-flex flex-column" style={{ maxHeight: '550px' }}>
                                ...
                                <button 
                                    className="editBtn-mixed" 
                                    onClick={() => navigate(`/salles/modifier/${salle.id}`)}
                                    >
      ...
      <style>{`
        .custom-scroll-horizontal::-webkit-scrollbar { height: 6px; }
        .custom-scroll-horizontal::-webkit-scrollbar-thumb { background: #d1d1d1; border-radius: 10px; }
