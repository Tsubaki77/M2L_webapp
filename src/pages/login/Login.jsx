...
const Login = () => {
  ...
  // AUTHENTIFICATION DÉSACTIVÉE - LOGIQUE COMMENTÉE
  ...
  return (
    <div className="login-wrapper">
      ...
      {/* ── GAUCHE : MESSAGE DE DÉSACTIVATION ── */}
      <div className="login-form-panel">
        <div className="login-form-inner">
          ...
          <h1 className="login-title">Mode Test</h1>
          <p className="login-subtitle">Authentification désactivée</p>
          ...
          <div style={{
            ...
            <strong>ℹ️ Authentification désactivée</strong>
            <p style={{ marginTop: '10px', marginBottom: '0' }}>
              La système de connexion est actuellement désactivé en mode test. 
          ...
          {/* ANCIENNE LOGIQUE COMMENTÉE - À RÉACTIVER
